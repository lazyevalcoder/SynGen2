...
| 20 | Mix shift to higher-margin tiers post-guardrails | 🟡 | WS8 period-varying categorical weights |
| 23 | Comp change → short-cycle small-deal behavior | 🟡 | WS8 per-period deal-size curves (minor) |
| 25 | 101% of plan via a few early outlier deals | 🟡 | WS8 mixture/outlier primitive + prior-year history |
